 ...
 */
var resourceObjectFromDocument = function(document) {
  if (!document) {
...
var responseDocument = function(data, included, errors) {
  var doc = {};
...
module.exports = {
  ...
  resourceObjectFromDocument: resourceObjectFromDocument,
  ...
  routeModelResources: function() {
    ...
    app.use(function(req, res, next) {
      ...
      res.sendResponseDocument = function(data, included, errors, status) {
        ...
        this.status(status).json(responseDocument(data, included, errors));
      };
      ...
      res.sendDocument = function(document, status) {
        res.sendResponseDocument(resourceObjectFromDocument(document), null, null, status);
      };
